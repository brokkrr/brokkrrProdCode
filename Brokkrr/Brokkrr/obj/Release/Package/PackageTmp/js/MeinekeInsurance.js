           ...
           '<div style="width:100%;">' +
               ...
               '<div class="question-div">' +
                  '<div class="next-question-div">' +
                       ...
                       '<div style="text-align:left;" class="next-question-button answer extra meinekegrosspayroll" id="$1.1million-$1.5million">$1.1million - $1.5million</div>' +
...
'</li>';
    ...
    grossrevenueforgarage = '<li id="grossrevenueforgarage_li" class="main mainliremove">' +
           '<span id="spangrossrevenueforgarageli" class="line hideline"></span> ' +
...
function IsLogin() {
    ...
    if (IsUserLogin == 'Authorize') {
        ...
        //$('#spangrossrevenueforgarageli').removeClass('line');//17May18
