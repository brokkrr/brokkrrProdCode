...
$(document).ready(function () {
   ...
   '</li>';
                   ...
                   '<div style="width:100%;">' +
                       ...
                       '<div class="question-div question-div1">' +
                           '<div class="next-question-div">' +
                               ...
                               '<div id="divMAuto" class="col-md-2 col-sm-2 col-xs-6"><center><img class="next-question-button img-responsive" id="Liability" src="../Images/NewAssets/Liability.png" alt="Liability" /></center><div style="text-align: center;margin-top: 7%;">Liability</div></div>' +
    ...
    planSize = '<li id="planSize_li" class="main mainliremove">' +
           '<span id="SpanPlanSizeline" class="line hideline"></span><span class="bullet"></span>' +
           '<div style="width:100%;">' +
               '<div class="question-bar">' +
           ...
           '<div style="width:100%;">' +
               ...
               '<div class="question-div">' +
                   '<div class="next-question-div">' +
                       ...
                       '<div style="text-align:left;" class="next-question-button answer extra apspgrosspayroll" id="$1.1million-$1.5million">$1.1million - $1.5million</div>' +
    ...
    language = '<li id="language_li" class="main mainliremove">' +
              ...
              '<div style="width:100%;">' +
                  ...
                  '<div class="col-sm-6 col-md-3 col-xs-12 question-div">' +
                      '<div class="next-question-div">' +
                      '<div class="col-sm-12 col-md-12 padding0" style="padding:0;">' +
    ...
    '<div class="next-question-div">' +
            ...
            '<div class="col-sm-12 col-md-12">' +
               ...
               //'<img src="../Images/NewAssets/sumbit.PNG" class="SubmitInsurance" style="cursor:pointer;" alt="Submit" />' +
                '<input class="SubmitInsurance seematches" type="button" value="See Matches" style="" />' +
            '</div>' +
             '<div class="col-sm-12 col-md-12">' +
                                       ...
                                       '<div class="question-div">' +
                                            '<div >' +
                                                    ...
                                                    '<div class="col-sm-12 col-md-12">' +
                                                       ...
                                                       '<input id="SubmitWithLogin" class="SubmitInsuranceWithLogin seematches" type="button" value="See Matches" style="" />' +
...
function IsLogin() {
    ...
    if (IsUserLogin == 'Authorize') {
        ...
        //11May18
       // $('#notes').removeClass('line');//17May18
       // $('#gross').removeClass('line');
       // $('#SpanPlanSizeline').removeClass('line');//17May18
    }
    else {
