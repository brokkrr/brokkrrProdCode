...
var newPurchaseOrCurrentlyInsured, whenNeedInsurence, noOfEmployee, industry, contactInformation, coverageamount, siccode, grossrevenue, acquisitionIsInsured,
    typeOfAuto, valueOfHome, language, notes, insuranceCompany, typeofinsurance, planSize, CurrentPlan, howManyStalls, NoofLocation, grossrevenueforgarage, SubmitWithLogin, NumberofEmployees, GrossPayroll, declaration, uploaddeclaration;
var colors;
var industryList, subIndustryList, insuranceCompanyList;
...
$(document).ready(function () {
    ...
    declaration = '<li id="declaration_li" class="main mainliremove">' +
          ...
          '<div style="width:100%;">' +
              '<div class="question-bar">' +
                  '<div class="qusetion">Do you have a current Dec Page? ( first page of your policy)</div>' +
    ...
    uploaddeclaration = '<li id="uploaddeclaration_li" class="main mainliremove classuploaddeclaration">' +
       ...
       '<div style="width:100%;">' +
           '<div class="question-bar">' +
               '<div class="qusetion">Upload document</div>' +
               '<div class="selectedanswer"></div>' +
   ...
   '</li>';
                       ...
                       '<div class="question-div question-div1">' +
                           '<div class="next-question-div">' +
                               ...
                               '<div id="Life_Ins" class="col-md-2 col-sm-2 col-xs-6"><center><img class="next-question-button img-responsive" id="Life Insurance" src="../Images/NewAssets/Mlife.png" alt="Life Insurance" /></center><div style="text-align: center;margin-top: 7%;">Life</div></div>' +
                                ...
                                '<div id="Busi_Ins" class="col-md-2 col-sm-2 col-xs-6"><center><img class="next-question-button img-responsive" id="General Liability" src="../Images/NewAssets/Mbusiness.png" alt="General Liability" /></center><div style="text-align: center;margin-top: 7%;">General Liability</div></div>' +
                                '<div id="EmpBene_Ins" class="col-md-2 col-sm-2 col-xs-6"><center><img class="next-question-button img-responsive" id="Employee Benefits" src="../Images/NewAssets/Mbenefits.png" alt="Employee Benefits" /></center><div style="text-align: center;margin-top: 7%;">Employee Benefits</div></div>' +
                               '<div id="divMWorkComp" class="col-md-2 col-sm-2 col-xs-6"><center><img class="next-question-button img-responsive" id="Workers Compensation" src="../Images/NewAssets/workers-compwhitebg.png" alt="Workers Compensation" /></center><div style="text-align: center;margin-top: 7%;">Workers Compensation</div></div>' +
    ...
    //       '<span class="line hideline"><span class="bullet"></span>' +
    //       '<div style="width:100%;">' +
    //           '<div class="question-bar">' +
    ...
    planSize = '<li id="planSize_li" class="main mainliremove">' +
          '<span id="spanPlanSize" class="line hideline"></span> <span class="bullet"></span>' +
          '<div style="width:100%;">' +
              '<div class="question-bar">' +
                  '<div class="qusetion">Plan Size?</div>' +
                  '<div class="selectedanswer"></div>' +
    ...
    notes = '<li id="notes_li" class="main mainliremove">' +
            '<span id="spanNotesline" class="line hideline"></span> <span class="bullet"></span>' +
            '<div style="width:100%;">' +
                '<div class="question-bar">' +
                ...
                '<div class="question-div">' +
                    '<div class="next-question-div">' +
                        '<div class="row">' +
                            '<div class="col-sm-12 col-md-12">' +
                                '<div class="col-sm-6 col-md-6">' +
                                    '<input type="text" id="notes" class="contactinfo" placeholder="Enter any notes" />' +
                                '</div>' +
                            '</div>' +
                            '<div class="col-sm-12 col-md-12">' +
                                '<div class="next-question-button answer-small-button" id="btnnote">Next >></div>' +
                                 //'<img src="../Images/NewAssets/sumbit.PNG" id="SubmitWithLogin" style="cursor:pointer;" class="" alt="Submit" />' +
                                  '<input id="SubmitWithLogin" type="button" value="See Matches" style="font-size: 1.3vw;font-weight: 600;color: #fff;width:15% !important;border-radius:31px;border: none;text-transform:none !important;font-family:open sans !important;font-weight:100;background-color: rgb(30,172,226);height: 46px;" />' +
                            '</div>' +
                                '<div class="col-sm-12 col-md-12">' +
                                   //'<div class="errormessage"></div>' +
                                '</div>' +
           ...
           '<div style="width:100%;">' +
               ...
               '<div class="question-div">' +
                   ...
                   '<div class="col-sm-12 col-md-12" style="padding:0;">' +
                       //'<select style="width: 24%;" id="language-select" class="select-insurance select-change">' +
...
'</li>';
    ...
    siccode = '<li id="siccode_li" class="main mainliremove">' +
            ...
            '<div style="width:100%;">' +
                '<div class="question-bar">' +
                    '<div class="qusetion">NAICS code</div>' +
                    '<div class="selectedanswer"></div>' +
                ...
                '<div class="question-div">' +
                    '<div class="next-question-div">' +
                    '<div class="col-sm-12 col-md-12">' +
                            '<div id="sic-select" style="border-bottom: 1px solid rgb(30,172,226);"></div>' +
                            '</div>' +
          ...
          '<div style="width:100%;">' +
              ...
              '<div class="question-div">' +
                 '<div class="next-question-div">' +
                      ...
                      '<div style="text-align:left;" class="next-question-button answer extra grosspayrollalign" id="$1.1million-$1.5million">$1.1million - $1.5million</div>' +
...
'<span class="line hideline"></span> <span class="bullet bulletdeclaration"></span>' +
'<div style="width:100%;">' +
'<div class="question-bar">' +
    ...
    '<div class="next-question-div">' +
            ...
            '<div class="col-sm-12 col-md-12">' +
               //'<img src="../Images/NewAssets/sumbit.PNG" class="SubmitInsurance" style="cursor:pointer;" alt="Submit" />' +
                '<input class="SubmitInsurance seematches" type="button" value="See Matches" />' +
            '</div>' +
             '<div class="col-sm-12 col-md-12">' +
                                                   ...
                                                   '<div class="question-div">' +
                                                        '<div >' +
                                                                ...
                                                                '<div class="col-sm-12 col-md-12">' +
                                                                   ...
                                                                   '<input id="SubmitWithLogin" class="SubmitInsuranceWithLogin seematches" type="button" value="See Matches" />' +
...
$(function () {
    ...
    //$(document.body).on('click', '.declarationNo', function () {
    //    //alert('No Clicked');
...
function mainfunction(selectedId, mode) {
    ...
    if (mode == 'click') {
        ...
        //alert("selectedId.id- " + selectedId.id);
        ...
        if (selectedId.id == 'declarationYes') {
            ...
            //alert("selectedId -" + selectedId + " , selectedId.id-" + selectedId.id);
            //13April18
    ...
    if (IsUserLogin != 'Authorize') {
        ...
        if ($("#LineType").val() == "401k") {
            appendcontatcus = SubmitWithLogin;
            //$("#spanPlanSize").hide();
        }
        else if ($("#LineType").val() == "Commercial" && $("#insurancetype").val() == "Workers Compensation") {
            appendcontatcus = SubmitWithLogin;
        }
        else {
            //11May18
    ...
    //alert("appendcontatcus-" + appendcontatcus)
    ...
    if (selectedId.id == 'General Liability') {
        $('#InsuranceOtherQuestion').append(grossrevenue + industry + siccode + language + notes + declaration + uploaddeclaration + appendcontatcus);
        $parent.nextAll('.main').hide();//hide all main question 
        fillIndustry();
        IsLogin();
        fillLanguage();
    ...
    if (selectedId.id == 'Workers Compensation') {
        ...
        fillLanguage();
        if (IsUserLogin == 'Authorize') {
            //$('#gross').removeClass('line');11May18
        }
        $('.ui-igcombo-field').prop('readonly', true);
        $('.ui-igcombo-field').prop("placeholder", "Please choose");
    }
    ...
    if (selectedId.id == '401k') {
        ...
        if (IsUserLogin == 'Authorize') {
            //$('#spanPlanSize').removeClass('line');11May18
            //alert("Here");
...
function IsLogin() {
    if (IsUserLogin == 'Authorize') {
       ...
       // $('#spanNotesline').removeClass("line");//17May18
       // $('#gross').removeClass("line");//17May18
       // $('#spanPlanSize').removeClass("line");//17May18
